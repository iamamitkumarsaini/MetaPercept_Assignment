...
function GridBox() {
    ...
    return (
        <div className='container' >
            {
                arr.map((elem) => (
                    <div key={elem.ID} className='innerDiv' >
                        <img className='image' src={elem.ImageUrl} alt={elem.Name} />
                        <div className='textBox'>
                        <h3>{elem.Name}</h3>
                        <p className='paraGraph'>{elem.ShortDesc}</p>
                        <button className='gridButton'>View</button>
                        </div>
                    </div>
                ))
            }
